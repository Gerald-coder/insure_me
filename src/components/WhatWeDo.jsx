      ...
      <div className="flex flex-col items-center w-[90vw] py-10 gap-4 px-3 md:flex-row md:justify-between">
        <div className="w-full text-white">
          ...
          <Description
            ...
            desc="Comprehensive coverage for medical expenses, hospitalization, and more."
          />
          <Description
            heading="Home Insurance"
            desc="Safeguard your home and belongings against unexpected events like fire, theft, and natural disasters."
          />
          <Description
            heading="Auto Insurance"
            desc="Drive with Confidence  We offer a range of auto insurance options to protect your vehicle and provide financial security in case of accidents"
          />
        </div>
